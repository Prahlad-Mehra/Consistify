...
const StaticCalender:React.FC= ()=> {
    ...
    return (
        <div className="w-70 lg:w-80 bg-white rounded-xl shadow-2xl border border-gray-200 p-4 transform rotate-3 hover:rotate-0 transition-transform duration-300">
          {/* Header with Title */}
